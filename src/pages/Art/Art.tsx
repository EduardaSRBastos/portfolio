...
export default function Art() {
    ...
    const images = [
      { src: "./Portfolio/Images/Art/Apple.png", alt: "Apple Stamp Digital Art", name: "Apple" },
      { src: "./Portfolio/Images/Art/Armadillo.png", alt: "Armadillo Stamp Digital Art", name: "Armadillo" },
      { src: "./Portfolio/Images/Art/Bat.png", alt: "Bat Sticker Digital Art", name: "Bat" },
      { src: "./Portfolio/Images/Art/Blue Lion.png", alt: "Colorful Lion Digital Art", name: "Blue Lion" },
      { src: "./Portfolio/Images/Art/Heist.png", alt: "Raccoon With a Banana Sticker Digital Art", name: "Heist" },
      { src: "./Portfolio/Images/Art/Kind.png", alt: "Cat and Bunny Friends Digital Art", name: "Kind" },
      { src: "./Portfolio/Images/Art/Leaves.png", alt: "Leaves Phone Wallpaper Digital Art", name: "Leaves" },
      { src: "./Portfolio/Images/Art/LittleMisfortune.png", alt: "Little Misfortune Wallpaper Digital Art", name: "LittleMisfortune" },
      { src: "./Portfolio/Images/Art/Snack.png", alt: "Halloween Snacks Sticker Digital Art", name: "Snack" },
      { src: "./Portfolio/Images/Art/Snail.png", alt: "Cute Snail Digital Art", name: "Snail" },
      { src: "./Portfolio/Images/Art/Twilight Sky.png", alt: "Twilight Sky And Forest Wallpaper Digital Art", name: "Twilight Sky" },
      { src: "./Portfolio/Images/Art/Tiger.png", alt: "Saber-Toothed Tiger Digital Art", name: "Tiger" },
      { src: "./Portfolio/Images/Art/Bluff.png", alt: "Pumpkin Bluffing Sticker Digital Art", name: "Bluff" }, 
      { src: "./Portfolio/Images/Art/Bouquet.png", alt: "Bouquet of Dark Red Roses Sticker Digital Art", name: "Bouquet" }, 
      { src: "./Portfolio/Images/Art/Bulbasaur Sticker.png", alt: "Bulbasaur Sticker Digital Art", name: "Bulbasaur" }, 
      { src: "./Portfolio/Images/Art/Candles.png", alt: "Candles on Table Digital Art", name: "Candles" }, 
      { src: "./Portfolio/Images/Art/Magpies.png", alt: "Magpies on Trunk Wallpaper Digital Art", name: "Magpies" }, 
      { src: "./Portfolio/Images/Art/Marinette.png", alt: "Marinette From Miraculous Ladybug Digital Art", name: "Marinette" }, 
      { src: "./Portfolio/Images/Art/Match.png", alt: "Match Lamp Digital Art", name: "Match" }, 
      { src: "./Portfolio/Images/Art/Muffin.png", alt: "Cat and Bunny Muffins Phone Wallpaper Digital Art", name: "Muffin" }, 
      { src: "./Portfolio/Images/Art/Soup.png", alt: "Soup On A Cat Mug Stamp Digital Art", name: "Soup" }, 
      { src: "./Portfolio/Images/Art/StevenLionBackground.png", alt: "Lion Landscape From Steven Universe Wallpaper Digital Art", name: "StevenLionBackground" }, 
      { src: "./Portfolio/Images/Art/StarNight.png", alt: "Star Night Wallpaper Digital Art", name: "StarNight" }, 
      { src: "./Portfolio/Images/Art/Scurry Cat.png", alt: "Running Cat Digital Art", name: "Scurry Cat" },
      { src: "./Portfolio/Images/Art/Crabby.png", alt: "Grumpy Cat Sticker Digital Art", name: "Crabby" },
      { src: "./Portfolio/Images/Art/Eagle.png", alt: "Eagle Over Forest Phone Wallpaper Digital Art", name: "Eagle" },
      { src: "./Portfolio/Images/Art/Farm.png", alt: "Skeleton Farmer Sticker Digital Art", name: "Farm" },
      { src: "./Portfolio/Images/Art/Flame - Calcifer.png", alt: "Calcifer Sticker Digital Art", name: "Flame - Calcifer" },
      { src: "./Portfolio/Images/Art/Nest.png", alt: "Raven Throwing Out Eggs From Nest Digital Art", name: "Nest" },
      { src: "./Portfolio/Images/Art/Night Sky.png", alt: "Night Sky Through Window Digital Art", name: "Night Sky" },
      { src: "./Portfolio/Images/Art/Oc 3D.png", alt: "Original Character Digital Art", name: "Oc 3D" },
      { src: "./Portfolio/Images/Art/Pancake.png", alt: "Banana Pancakes Digital Art", name: "Pancake" },
      { src: "./Portfolio/Images/Art/Tempting.png", alt: "Hands Holding Apple From Twilight Digital Art", name: "Tempting" },
      { src: "./Portfolio/Images/Art/TreeBannerSunset.png", alt: "Flower Tree At Sunset Wallpaper Digital Art", name: "TreeBannerSunset" },
      { src: "./Portfolio/Images/Art/Scrape.png", alt: "Cat Scratching Wall Digital Art", name: "Scrape" },
      { src: "./Portfolio/Images/Art/Metanimal Band.png", alt: "Animal Rock Band With Capybara, Cat And Bee Digital Art", name: "Metanimal Band" },
      { src: "./Portfolio/Images/Art/Forget.png", alt: "Blue Witch Digital Art", name: "Forget" },
      { src: "./Portfolio/Images/Art/Fowl.png", alt: "Chicken Over Pumpkin Sticker Digital Art", name: "Fowl" },
      { src: "./Portfolio/Images/Art/Fox.png", alt: "Fox Phone Wallpaper Digital Art", name: "Fox" },
      { src: "./Portfolio/Images/Art/Fungi.png", alt: "Mushrooms Digital Art", name: "Fungi" },
      { src: "./Portfolio/Images/Art/Pizza.png", alt: "Pizza On Wheels Digital Art", name: "Pizza" },
      { src: "./Portfolio/Images/Art/Ponytail.png", alt: "Yato Digital Art", name: "Ponytail" },
      { src: "./Portfolio/Images/Art/Salty.png", alt: "Cubes of Pink Salt Digital Art", name: "Salty" },
      { src: "./Portfolio/Images/Art/Scallop.png", alt: "Scallop On Black Sand Sticker Digital Art", name: "Scallop" },
      { src: "./Portfolio/Images/Art/Trip.png", alt: "Yellow Van Passing Through A Pumpkin Patch Sticker Digital Art", name: "Trip" },
      { src: "./Portfolio/Images/Art/Cat404.png", alt: "Cat With A Electrical Plug Sticker Digital Art", name: "Cat404" },
      { src: "./Portfolio/Images/Art/Charmander Sticker.png", alt: "Charmander Sticker Digital Art", name: "Charmander Sticker" },
      { src: "./Portfolio/Images/Art/Campfire.png", alt: "Campfire Digital Art", name: "Campfire" }
    ];
